...
När du katalogiserar en bok via ISBN (Ctrl+I eller verktygsfältsknappen) hämtar BookDB metadata från tre publika API:er samtidigt.
...
**Noteringar:**
- Ingen API-nyckel krävs för grundläggande sökningar
