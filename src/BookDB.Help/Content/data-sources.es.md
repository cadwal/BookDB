...
Cuando cataloga un libro por ISBN (Ctrl+I o el botón de la barra de herramientas), BookDB obtiene metadatos de tres API públicas simultáneamente.
...
**Notas:**
- No se requiere clave de API para búsquedas básicas
