...
/// failure while a screen is rendered fails that test. Only the binding area is enabled — other log noise is
/// dropped.
/// <para>
/// A near-copy of the desktop harness's sink. The two harnesses build different apps and are meant to be able
/// to move independently, so they are not sharing a project for sixty lines of plumbing.
/// </para>
/// </summary>
