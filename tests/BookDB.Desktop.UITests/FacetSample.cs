...
/// (solo) and 2 (shared), so filtering by a facet's shared value narrows the list to exactly the two shared books.
/// </summary>
public static class FacetSample
{
    ...
    public static async Task SeedAsync(TestHost host, CancellationToken ct)
    {
